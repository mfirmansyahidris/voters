...
export default class EdirUser extends Component {
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        Axios.get('http://localhost:5353/users/' + this.props.match.params.id)
            .then(res => {
                this.setState({
    ...
    onSubmit(e){
        ...
        Axios.post('http://localhost:5353/users/update/' + this.props.match.params.id, user)
